...
<div class="store_info">
    <div class="sit_test sit_2_test busy">7</div>
    - Занято <br>
    <div class="sit_test sit_2_test sel_test">7</div>
    - Выбрано <br>
    <div class="sit_test sit_2_test ">7</div>
    - Нижняя полка <br>
    <div class="sit_test sit_1_test ">7</div>
    - Верхняя полка <br>
...
<script>
    ...
    $(".buy_button").click(function () {
        var i = $(".sel").attr('id');
        var car = String(i).split('_')[1];
        var sit = String(i).split('_')[0];
        var id = String(i).split('_')[2] + "_" + String(i).split('_')[3] + "_" + String(i).split('_')[4];
        $.ajax({
            url: 'ticket/buy',
            type: 'post',
            data: {"numSit": sit + "_" + car, "id": id},
            success: function (response) {
                if (response == "") {
                    if ($(".user_name").text() == "\u0420\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446\u0438\u044F\u0020\u007C\u0020\u0412\u0445\u043E\u0434" || $(".user_name").text() == "Регистрация | Вход") {
                        $(".resp_info").text("\u0412\u043E\u0439\u0434\u0438\u0442\u0435\u0020\u0432\u0020\u043B\u0438\u0447\u043D\u044B\u0439\u0020\u043A\u0430\u0431\u0438\u043D\u0435\u0442\u002E")
                            .fadeIn(1000);
                        $.ajax({
                            url: "user",
                            type: "post",
