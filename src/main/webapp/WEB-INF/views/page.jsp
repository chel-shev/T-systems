...
<div class="container">
    <div class="row header_row">
        <header>
            <div class="cols col-5">
                <div class="logo">
                    <svg version="1.1" width="3.5em" height="3.5em" viewBox="0 0 486.208 486.208"
            ...
            <div class="cols col-8">
                <ul class="menu-ul">
                    <li class="menu-li"><a id="schedule" class="menu-a" href="#schedule">
    ...
    <%@include file="ticket_search.jsp" %>
    </div>
